  ...
  return (
    <section className="relative overflow-hidden bg-[linear-gradient(135deg,#F1F6FF_0%,#E8F1FF_100%)] py-20 lg:py-28">
      ...
      <div className="site-container relative grid items-stretch gap-10 lg:grid-cols-[.78fr_1.42fr] lg:gap-14">
        {/* Rating Card Left */}
        <aside className="group relative min-h-[470px] overflow-hidden rounded-[28px] bg-[#101B38] text-white shadow-[0_28px_70px_rgba(18,55,184,.22)] transition duration-500 hover:shadow-[0_34px_80px_rgba(18,55,184,.3)]">
          <Image
          ...
          <div className="absolute inset-x-0 bottom-0 p-7 sm:p-9">
            <p className="text-[11px] font-bold uppercase tracking-[0.18em] text-[#50C710]">
              Kepuasan Rombongan
            </p>
            <div className="mt-3 flex items-end gap-2">
              <strong className="text-6xl font-bold leading-none tracking-[-0.06em]">4.9</strong>
              <span className="pb-1 text-2xl font-semibold text-[#50C710]">/5</span>
            </div>
            <div className="mt-4">
              <Stars />
            </div>
            ...
            <a
              href="#kontak"
              className="mt-6 inline-flex items-center gap-2 rounded-full bg-white px-5 py-2.5 text-xs font-bold text-[#101B38] transition hover:-translate-y-1 hover:bg-[#F1F6FF] hover:shadow-md"
            >
        ...
        <div className="flex flex-col justify-center">
          <header>
            <p className="text-[11px] font-bold uppercase tracking-[0.2em] text-[#1237B8]">
              Testimoni Rombongan
            </p>
            <h2 className="mt-3 max-w-[660px] text-3xl font-bold leading-[1.08] tracking-[-0.045em] text-[#101B38] sm:text-[42px]">
              Dipercaya untuk<br />
          ...
          {/* Featured Review */}
          <article className="group relative mt-8 rounded-[22px] border border-white bg-white p-6 shadow-[0_18px_46px_rgba(18,55,184,.09)] transition-all duration-300 hover:-translate-y-1.5 hover:shadow-[0_26px_56px_rgba(18,55,184,.16)] sm:p-7">
            ...
            <p className="relative max-w-[640px] text-sm leading-7 text-[#475569]">
            ...
            <div className="mt-5 flex flex-wrap items-center justify-between gap-4 border-t border-[#E2E8F0] pt-5">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <strong className="block text-sm text-[#101B38]">{featured.name}</strong>
                  <span className="mt-0.5 flex items-center gap-1 text-xs text-[#65708A]">
              ...
              <div className="flex items-center gap-3">
                <Stars />
                <span className="text-[10px] font-semibold text-[#65708A]">Ulasan Pelanggan</span>
              </div>
            </div>
          </article>
          ...
          <div className="mt-7 grid gap-6 sm:grid-cols-2">
            {others.map((item) => (
              <article
                key={item.name}
                className="group rounded-[18px] border border-white/80 bg-white/70 p-5 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:bg-white hover:shadow-[0_16px_36px_rgba(18,55,184,.1)]"
              >
                <Quote className="size-7 fill-[#1237B8]/10 text-[#1237B8] transition duration-300 group-hover:scale-110" />
                <p className="mt-2 text-[13px] leading-6 text-[#475569]">&ldquo;{item.quote}&rdquo;</p>
                <div className="mt-4 flex items-center justify-between gap-3 border-t border-[#E2E8F0]/70 pt-3">
                  <div className="flex items-center gap-2.5">
                    <span className="grid size-9 place-items-center rounded-full bg-[#F5F0FF] text-[10px] font-bold text-[#6920CC]">
                      {item.initials}
                    </span>
                    <div>
                      <strong className="block text-xs text-[#101B38]">{item.name}</strong>
                      <span className="text-[10px] text-[#65708A]">{item.city}</span>
                    </div>
                  </div>
                  <Stars />
                </div>

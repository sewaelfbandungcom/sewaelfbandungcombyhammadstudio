...
import { ArrowRight, Building2, Home, MapPin, Phone } from "lucide-react";
...
const advantages = [
  {
    ...
    color: "text-[#1237B8] bg-[#F1F6FF] border-[#1237B8]/20",
  },
  {
    icon: UsersThreeIcon,
    title: "Cocok untuk Perjalanan Rombongan",
    color: "text-[#6920CC] bg-[#F5F0FF] border-[#6920CC]/20",
  },
  {
    icon: CompassIcon,
    title: "Melayani Bandung & Luar Kota",
    color: "text-[#2857E8] bg-[#EFF6FF] border-[#2857E8]/20",
  },
  {
    icon: TagIcon,
    title: "Harga Kompetitif",
    color: "text-[#50C710] bg-[#F2FBEA] border-[#50C710]/30",
  },
  {
    icon: HandshakeIcon,
    title: "Pelayanan Ramah & Profesional",
    color: "text-[#D97706] bg-[#FFFBEB] border-[#D97706]/20",
  },
  {
    icon: CalendarCheckIcon,
    title: "Reservasi Mudah & Fleksibel",
    color: "text-[#1237B8] bg-[#F1F6FF] border-[#1237B8]/20",
  },
];
      ...
      <main>
        ...
        <section className="relative flex min-h-[280px] sm:min-h-[340px] items-end overflow-hidden pb-8 sm:pb-10 pt-[116px] sm:pt-[136px] text-white">
          ...
          <div className="site-container relative z-10 w-full">
            ...
            <p className="mt-1.5 max-w-[640px] text-xs sm:text-sm font-medium text-slate-200">
            ...
            <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr] lg:gap-12 items-center">
              <div>
                <span className="inline-flex items-center gap-1.5 rounded-md bg-[#F1F6FF] px-2.5 py-1 text-xs font-extrabold uppercase tracking-wider text-[#1237B8]">
                  <Building2 className="size-3.5" /> Profil Perusahaan
                </span>
        ...
        {/* 6 Keunggulan Kami (with Professional Phosphor Icons) */}
        <section className="py-10 sm:py-14 bg-[#F1F6FF]">
          <div className="site-container">
            ...
            <p className="mt-1 text-center text-xs text-[#64748B]">
              Komitmen kami menghadirkan perjalanan yang nyaman, aman, dan terpercaya.
            </p>
            ...
            <div className="mt-6 sm:mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              {advantages.map((adv, idx) => {
                ...
                return (
                  <div
                    key={idx}
                    className="flex items-center gap-3.5 rounded-2xl border border-[#DCE5F0] bg-white p-4 sm:p-5 shadow-2xs transition duration-200 hover:border-[#1237B8]/40 hover:shadow-sm"
                  >
                    <span className={`grid size-12 shrink-0 place-items-center rounded-xl border ${adv.color}`}>

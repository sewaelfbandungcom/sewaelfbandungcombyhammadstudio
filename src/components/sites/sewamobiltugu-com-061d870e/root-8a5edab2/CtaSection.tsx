...
export function CtaSection() {
  return (
    <section className="bg-[#F1F6FF] pb-16 pt-3">
      <div className="group site-container relative min-h-[410px] overflow-hidden rounded-[28px] border border-[#1237B8]/30 bg-[#101B38] text-white shadow-[0_34px_80px_rgba(18,55,184,.25)] transition duration-500 hover:-translate-y-1 hover:shadow-[0_42px_95px_rgba(18,55,184,.3)]">
        ...
        <div className="absolute inset-0 bg-[linear-gradient(90deg,rgba(16,27,56,.99)_0%,rgba(18,55,184,.95)_46%,rgba(105,32,204,.25)_78%)]" />

...
export const fleetCategories: CategoryInfo[] = [
  {
    ...
    subtitle: "Kapasitas 8 s/d 21 Orang",
    description:
      "Pilihan microbus Isuzu Elf Long Euro4 serta Toyota Hiace Premio & Commuter berstandar prima. Pilihan utama untuk wisata Lembang, Ciwidey, study tour, gathering kantor, dan drop luar kota.",
    count: 6,
  },
  {
    key: "bus",
...
export const fleetItems: FleetItem[] = [
  // --- KATEGORI 1: ELF & HIACE ---
  {
    ...
    price: "Rp 1.400.000",
    priceNum: 1400000,
    badge: "Favorit Rombongan",
    isPopular: true,
    image: "/images/armada/elf-long.webp",
    features: ["18 - 19 Kursi Reclining", "Muat Rombongan Besar", "AC Sejuk & Dingin", "Bagasi Belakang Luas"],
  },
  {
    id: "elf-long-euro4",
    name: "Elf Long Euro4",
    ...
    features: ["19 - 21 Kursi Nyaman", "Mesin Euro4 Terbaru & Senyap", "Kabin Wangi & Bersih", "Suspensi Stabil & Empuk"],
  },
  {
    id: "hiace-commuter",
    name: "Hiace Commuter",
  ...
  },
  {
    ...
    features: ["Captain Seat VIP", "Interior Mewah Wood Panel", "Smart TV & Audio Karaoke", "Suasana Eksekutif"],
  },

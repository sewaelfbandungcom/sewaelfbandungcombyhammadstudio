...
export const fleetCategories: CategoryInfo[] = [
  {
    ...
    description:
      "Pilihan microbus Isuzu Elf Long, Elf Coaster, serta Toyota Hiace Premio & Commuter berstandar prima. Pilihan utama untuk wisata Lembang, Ciwidey, study tour, gathering kantor, dan drop luar kota.",
    count: 8,
  },
  {
    key: "bus",

        ...
        <div className="site-container relative z-10 flex min-h-[830px] items-start pb-[220px] pt-[175px] sm:min-h-[860px] sm:pt-[190px] lg:min-h-[890px] lg:items-center lg:pb-[190px] lg:pt-[150px]">
          <div className="max-w-[680px]">
            ...
            <div className="hero-reveal hero-delay-4 mt-8 flex flex-wrap gap-3">
              <a href={bookingUrl()} target="_blank" rel="noreferrer" className="inline-flex h-12 items-center gap-2 rounded-xl bg-[#50C710] hover:bg-[#43aa0c] px-6 text-sm font-bold text-white shadow-[0_12px_28px_rgba(80,199,16,.35)] transition hover:-translate-y-0.5">
          ...
          <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-[1fr_1fr_1.05fr_.72fr_auto] xl:items-end">
            {bookingFields.map(({ label, value, icon: Icon }) => (
              <label key={label} className="block text-[11px] font-bold text-[#65708A]">
                {label}
                <span className="mt-2 flex h-14 items-center gap-3 rounded-xl border border-[#DCE5F0] bg-[#F1F6FF] px-4 text-sm font-medium text-[#101B38] shadow-[inset_0_1px_2px_rgba(18,55,184,.025)]">
                  <span className="grid size-8 place-items-center rounded-lg bg-white text-[#1237B8] shadow-sm">
            ...
            <a href={bookingUrl()} target="_blank" rel="noreferrer" className="flex h-14 items-center justify-center gap-2 rounded-xl bg-[#50C710] hover:bg-[#43aa0c] px-7 text-sm font-bold text-white shadow-[0_14px_28px_rgba(80,199,16,.3)] transition hover:-translate-y-0.5 hover:shadow-[0_18px_34px_rgba(80,199,16,.36)]">

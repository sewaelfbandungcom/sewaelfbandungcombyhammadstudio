...
Mohon info ketersediaan unit dan penawaran harga terbaiknya. Terima kasih!`;
  ...
  return (
    <section className="relative bg-[#F1F6FF] text-[#101B38]">
      {/* Hero Background Container - Structure Preserved with Clean White/Light Overlay */}
      <div className="relative min-h-[840px] overflow-hidden rounded-b-[52px] bg-white sm:min-h-[870px] sm:rounded-b-[68px] lg:min-h-[900px] lg:rounded-b-[92px] shadow-sm">
        <Image
        ...
        {/* Hero Content with Exact Same Structure */}
        <div className="site-container relative z-10 flex min-h-[840px] items-start pb-[220px] pt-[175px] sm:min-h-[870px] sm:pt-[190px] lg:min-h-[900px] lg:items-center lg:pb-[190px] lg:pt-[150px]">
          <div className="max-w-[680px]">
            <p className="hero-reveal hero-delay-1 mb-5 inline-flex items-center gap-2 rounded-full border border-[#1237B8]/20 bg-white/90 px-3.5 py-2 text-[10px] font-bold uppercase tracking-[0.16em] text-[#1237B8] shadow-xs backdrop-blur-md">
            ...
            <h1 className="hero-reveal hero-delay-2 max-w-[680px] text-[43px] font-bold leading-[1.06] tracking-[-0.05em] text-balance text-[#101B38] sm:text-[56px] lg:text-[60px]">
              Sewa Elf &amp; Hiace di <span className="text-[#1237B8]">Bandung,</span><br />
              Nyaman untuk <span className="text-[#50C710]">Rombongan</span>
            </h1>

            <p className="hero-reveal hero-delay-3 mt-6 max-w-[560px] text-[15px] leading-7 text-[#65708A] sm:text-base">
            ...
            <div className="hero-reveal hero-delay-4 mt-8 flex flex-wrap gap-3">
              ...
              <a
                href="#armada"
                className="inline-flex h-12 items-center gap-2 rounded-xl border border-[#DCE5F0] bg-white/90 px-6 text-sm font-bold text-[#101B38] shadow-xs backdrop-blur transition hover:border-[#1237B8] hover:text-[#1237B8] hover:bg-white"
              >
            ...
            <div className="hero-reveal hero-delay-5 mt-7 flex flex-wrap items-center gap-x-5 gap-y-3">
              ...
              <p className="text-[11px] leading-4 text-[#65708A]">
                <strong className="block text-xs text-[#101B38]">5.000+ rombongan terlayani</strong>
                di Bandung dan berbagai kota
              </p>
              <span className="flex items-center gap-2 text-[11px] font-semibold text-[#101B38]">
                <span className="grid size-5 place-items-center rounded-full border border-[#50C710]/40 bg-[#50C710]/20 text-[#50C710]">
      ...
      <div className="hero-reveal hero-delay-6 site-container relative z-20 -mt-[112px] pb-6 sm:-mt-[124px] lg:-mt-[130px] lg:pb-8">
        <form
          ...
          className="rounded-[24px] border border-[#DCE5F0] bg-white p-6 text-[#101B38] shadow-[0_30px_80px_rgba(18,55,184,.12)] sm:p-8"
        >
          <div className="mb-6 flex flex-col justify-between gap-2 sm:flex-row sm:items-center">
            <div>
              ...
              <h2 className="mt-1.5 text-lg font-bold tracking-[-0.025em] text-[#101B38]">
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-[1.1fr_1.15fr_1.1fr_0.9fr_auto] xl:items-end">
            ...
            <div>
              ...
              <div className="mt-1.5 flex h-14 items-center gap-2.5 rounded-xl border border-[#DCE5F0] bg-[#F8FAFC] px-3.5 transition-all focus-within:border-[#1237B8] focus-within:bg-white focus-within:ring-2 focus-within:ring-[#1237B8]/20 shadow-[inset_0_1px_2px_rgba(0,0,0,.025)]">
